<template>
    <div class="w-full bg-[#252F3E] overflow-x-hidden">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 h-full flex  flex-col justify-around items-center md:items-center">
